    ...
    <div class="main-nav">
      ...
      <div class="main-nav-top">
        <div class="main-nav-top-left">
          <span style="font-size:26px;">全站检索</span>
          Total Station Retrieval
        </div>
        <div class="main-nav-top-right">
          ...
          <router-link to='/allSearch'
                       Id="Breadcrumb"
                       style="color:#2c3e50;text-decoration: none;">全站检索</router-link>
        </div>
        ...
        <el-tabs :tab-position="tabPosition"
          ...
          <el-tab-pane v-for="item in tabLists"
            ...
            <div class="main-nav-bot-tabs"
                 v-for="list in item.NewsTabContent"
                 :key="list.ID">
            ...
            <div class="main-nav-bot-tabs"
                 v-for="list in item.VideoTabContent"
                 :key="list.ID">
...
import { ip, resNews, resVideo } from '@/api/date'
// 引入video样式
  ...
  data () {
    return {
      ...
      tabLists: [{
        ...
        NewsTabContent: [{
          ID: 1001,
          Title: 'player将拥有流体大小。换句话说，它将按比例缩放以适应其容器',
          MemLoginID: 1000,
          isType: 1
        },
        {
        ...
        VideoTabContent: [{
          CoverImage: '/ImgUpload/Image/20190626091813181313643.jpg',
          Description: '扶贫',
          ID: 1000,
          MemLoginID: 1000,
          IsType: 3,
          Title: '扶贫',
          Url: '/ImgUpload/Video/20190626091819181993364.mp4'
        }]
      }],
      relatedLinksValue: '',
      tabPosition: 'left',
